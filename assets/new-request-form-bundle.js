...
function NewRequestForm({ requestForm, wysiwyg, newRequestPath, parentId, parentIdPath, locale, baseLocale, hasAtMentions, userRole, userId, brandId, organizations, answerBotModal, }) {
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [parentId && (jsxRuntimeExports.jsx(StyledParagraph, { children: jsxRuntimeExports.jsx(Anchor, { href: parentIdPath, children: t("new-request-form.parent-request-link", "Follow-up to request {{parentId}}", {
                        ...
                        switch (field.type) {
                            case "subject":
                                return (jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [jsxRuntimeExports.jsx(Input, { field: field, onChange: (value) => handleChange(field, value) }), jsxRuntimeExports.jsx(SuggestedArticles, { query: field.value, locale: locale })] }, field.name));
                            case "text":
                            case "integer":
                            case "decimal":
                            case "regexp":
                            ...
                            case "partialcreditcard":
                                return (jsxRuntimeExports.jsx(CreditCard, { field: field, onChange: (value) => handleChange(field, value) }, field.name));
                            case "description":
                            ...
                            case "basic_priority":
                            case "tickettype":
                                return (jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [jsxRuntimeExports.jsx(DropDown, { field: field, onChange: (value) => handleChange(field, value) }), field.value === "task" && (jsxRuntimeExports.jsx(DatePicker, { field: dueDateField, locale: baseLocale, valueFormat: "dateTime", onChange: (value) => {
                                                handleDueDateChange(value);
                                            } }))] }, field.name));
                            case "checkbox":
                                return (jsxRuntimeExports.jsx(Checkbox, { field: field, onChange: (value) => handleChange(field, value) }, field.name));
                            case "date":
                                return (jsxRuntimeExports.jsx(DatePicker, { field: field, locale: baseLocale, valueFormat: "date", onChange: (value) => handleChange(field, value) }, field.name));
                            case "multiselect":
                                return jsxRuntimeExports.jsx(MultiSelect, { field: field }, field.name);
                            case "tagger":
                            ...
                            default:
                                return jsxRuntimeExports.jsx(reactExports.Fragment, {}, field.name);
                        }
